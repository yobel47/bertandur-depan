        ...
        <div className="relative bg-white rounded-lg shadow ">
          ...
          <div className="p-6 text-center flex flex-col items-center justify-center">
            ...
            <h3 className="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">
              Apakah anda yakin ingin memverifikasi data {props.title} ini?
            </h3>
            <div className="mb-5">
              <button
                ...
                type="button"
                onClick={onVerif}
                className="text-white bg-[#FFA500] hover:bg-[#C17D00] focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center mr-2"
              >
                Ya, saya yakin
              </button>
              <button
