...
export function NavItemRoot({ item, isCollapse, open = false, active, onOpen }) {
  ...
  const renderContent = (
    <>
      {icon && (
        <ListItemIconStyle isCollapse={isCollapse} activeRoot={active}>
          {icon}
        </ListItemIconStyle>
      )}
  ...
  if (children) {
    return (
      <ListItemStyle isCollapse={isCollapse} onClick={onOpen} activeRoot={active}>
        {renderContent}
      </ListItemStyle>
    );
  }
  ...
  return isExternalLink(path) ? (
    <ListItemStyle isCollapse={isCollapse} component={Link} href={path} target="_blank" rel="noopener">
      {renderContent}
    </ListItemStyle>
  ) : (
    <ListItemStyle isCollapse={isCollapse} component={RouterLink} to={path} activeRoot={active}>
      {renderContent}
    </ListItemStyle>
  );
}
